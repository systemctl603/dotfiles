...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.layout.margin(vol_widget, 10, 10, 7, 7),
            wibox.widget.textbox(" "),
            wibox.layout.margin(bat_widget, 10, 10, 7, 7),
            mytextclock,
            wibox.layout.margin(wibox.widget.systray(), 10, 3, 3, 3),
        },
    }
...
awful.rules.rules = {
    ...
    { rule_any = { type = { "dialog" }, class = { "Blueman-adapters" } }, 
      properties = { 
...
-- Autostart the programs in the autostart.sh file
